...
This game is built using the Godot Engine.
	- **License:** MIT License
	- **Copyright:** Copyright (c) 2014-present Juan Linietsky, Ariel Manzur, and all the Godot Engine contributors.

- Pixel Operator Font
Used for UI text rendering and in-game labeling.
	- **License:** Creative Commons CC0 1.0 Universal Public Domain Dedication
	- **Waiver:** To the greatest extent permitted by law, the authors have waived all copyright and related or neighboring rights worldwide.

- Twemoji Font
Used for core text icon elements and vector representations.
	- * **License:** Creative Commons Attribution 4.0 International (CC-BY 4.0)
	- * **Attribution:** Copyright Twitter, Inc. and other contributors.

- EmojiOne SVGinOT Font Code
Integrated within the font mapping rendering suite.
	- **License:** MIT License
	- **Copyright:** Copyright (c) 2024 Brad Erickson

## Crowded Skies Source Code

Licensed under the Apache License, Version 2.0 (the "License"); you may not use this software infrastructure except in compliance with the License. You may obtain a copy of the License at: http://www.apache.org/licenses/LICENSE-2.0
