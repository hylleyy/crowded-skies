# Privacy Policy for Crowded Skies
...
While we do not actively collect data, the Game is distributed through the Google Play Store and built using third-party software.

- *Google Play Services*: When you download and use apps from the Google Play Store, Google may collect standard telemetry, crash reports, and device information based on your Google account settings. We do not have direct access to your personal data through this service and have no control over it.

- *Godot Engine*: The game is built using Godot Engine 4. The standard engine export used for this game does not contain built-in analytics, ads, or tracking software.

4. **Children's Privacy**

Because our game does not collect any personal information from any user, it inherently complies with the Children's Online Privacy Protection Act (COPPA) and similar global regulations. We do not knowingly collect personal information from children under the age of 13 (or any other age).

5. **Open Source and Transparency**

The source code for *Crowded Skies* is publicly available under the Apache License, Version 2.0. Anyone is free to audit the source code to verify that no hidden data collection or unauthorized network activity takes place.

6. **Changes to this Privacy Policy**

We may update our Privacy Policy from time to time. If we make significant changes, we will update the "Effective Date" at the top of this policy. Since we do not collect contact information, we encourage you to review this page periodically for any updates.
